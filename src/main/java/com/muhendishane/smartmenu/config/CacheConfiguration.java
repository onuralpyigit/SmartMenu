package com.muhendishane.smartmenu.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SmartMenu");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SmartMenu");
        ...
        config.getMapConfigs().put("com.muhendishane.smartmenu.domain.*", initializeDomainMapConfig(jHipsterProperties));
